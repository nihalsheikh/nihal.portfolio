...
const NodeUniform = require("./NodeUniform.js");
const NodeAttribute = require("./NodeAttribute.js");
const NodeVary = require("./NodeVary.js");
const NodeVar = require("./NodeVar.js");
const NodeCode = require("./NodeCode.js");
const NodeKeywords = require("./NodeKeywords.js");
...
class NodeBuilder {
  ...
  addNode(node) {
    if (this.nodes.indexOf(node) === -1) {
      ...
      if (updateType !== constants.NodeUpdateType.None) {
  ...
  getTextureEncodingFromMap(map) {
    ...
    if (map && map.isTexture) {
      if ("colorSpace" in map)
        encoding = map.colorSpace === "srgb" ? 3001 : 3e3;
      else
        encoding = map.encoding;
    } else if (map && map.isWebGLRenderTarget) {
      if ("colorSpace" in map.texture)
        encoding = map.texture.colorSpace === "srgb" ? 3001 : 3e3;
      else
  ...
  getSignature() {
    return `// Three.js r${THREE.REVISION} - NodeMaterial System
`;
  }
}
exports.default = NodeBuilder;
exports.shaderStages = shaderStages;
