...
var SAOPass = function(scene, camera, depthTexture, useNormals, resolution) {
  ...
  if (DepthLimitedBlurShader.DepthLimitedBlurShader === void 0) {
  ...
  if (UnpackDepthRGBAShader.UnpackDepthRGBAShader === void 0) {
...
SAOPass.prototype = Object.assign(Object.create(Pass.Pass.prototype), {
  constructor: SAOPass,
