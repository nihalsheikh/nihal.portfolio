...
var Capsule = function() {
  ...
  function Capsule2(start, end, radius) {
    this.start = start == void 0 ? new THREE.Vector3(0, 0, 0) : start;
    this.end = end == void 0 ? new THREE.Vector3(0, 1, 0) : end;
  ...
  Object.assign(Capsule2.prototype, {
    ...
    lineLineMinimumPoints: function(line1, line2) {
      ...
      var a = r.dot(s), b = r.dot(r), c = s.dot(s), d = s.dot(w), e = r.dot(w);
