  ...
  _getFormat(texture) {
    ...
    switch (format) {
      case THREE.RGBA_S3TC_DXT1_Format:
        formatGPU = isSRGB ? constants.GPUTextureFormat.BC1RGBAUnormSRGB : constants.GPUTextureFormat.BC1RGBAUnorm;
        break;
      case THREE.RGBA_S3TC_DXT3_Format:
        formatGPU = isSRGB ? constants.GPUTextureFormat.BC2RGBAUnormSRGB : constants.GPUTextureFormat.BC2RGBAUnorm;
        break;
      case THREE.RGBA_S3TC_DXT5_Format:
        formatGPU = isSRGB ? constants.GPUTextureFormat.BC3RGBAUnormSRGB : constants.GPUTextureFormat.BC3RGBAUnorm;
        break;
      case THREE.RGBAFormat:
        switch (type) {
          case THREE.UnsignedByteType:
            formatGPU = isSRGB ? constants.GPUTextureFormat.RGBA8UnormSRGB : constants.GPUTextureFormat.RGBA8Unorm;
            break;
