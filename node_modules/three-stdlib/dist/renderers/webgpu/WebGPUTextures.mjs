import { GPUTextureFormat, GPUAddressMode, GPUFilterMode, GPUTextureDimension } from "./constants.mjs";
import { Texture, NearestFilter, CubeTexture, RepeatWrapping, MirroredRepeatWrapping, NearestMipmapNearestFilter, NearestMipmapLinearFilter, RGFormat, FloatType, HalfFloatType, UnsignedByteType, RedFormat, RGBAFormat, RGBA_S3TC_DXT5_Format, RGBA_S3TC_DXT3_Format, RGBA_S3TC_DXT1_Format, LinearFilter } from "three";
import WebGPUTextureUtils from "./WebGPUTextureUtils.mjs";
  ...
  initRenderTarget(renderTarget) {
    ...
    if (renderTargetProperties.initialized === void 0) {
      ...
      if (renderTarget.depthBuffer === true) {
        const depthTextureFormat = GPUTextureFormat.Depth24PlusStencil8;
